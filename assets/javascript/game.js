$(document).ready(function(){
    ...
    var randomYellow = Math.floor(Math.random() * (12 - 1 + 1)) + 1;  
    ...
    function reset() {
        ...
        randomYellow = Math.floor(Math.random() * (12 - 1 + 1)) + 1;  
    ...
    function addToScoreBlue() {
        ...
        function addToScoreYellow() {
              var numberToAdd = parseInt(randomYellow);
              var currentScore=parseInt(totalScore);
             totalScore = numberToAdd + parseInt(currentScore);
        }
